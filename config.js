...
const CONFIG = {
    ...
    CHECK_LATEST_WORKFLOW_ID: 'trigger-repository-check-all-adapters.yml',
    CHECK_TASKS_LATEST_WORKFLOW_ID: 'checkLatestRepositories.yml',
    ...
    MANAGE_PRS_LATEST_WORKFLOW_ID: 'trigger-manage-pr-all-adapters.yml',
    MANAGE_PRS_TARGET_LATEST_WORKFLOW_ID: 'processLatestRepositories.yml',
    ...
    ANNOUNCEMENT_LATEST_WORKFLOW_ID: 'trigger-announcement-all-adapters.yml',
    ANNOUNCEMENT_TARGET_LATEST_WORKFLOW_ID: 'announceLatestRepositories.yml',
